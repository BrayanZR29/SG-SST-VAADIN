...
const Re = "copilot-", ts = "24.4.21", Dl = "attention-required", Cl = "https://plugins.jetbrains.com/plugin/23758-vaadin", Tl = "https://marketplace.visualstudio.com/items?itemName=vaadin.vaadin-vscode", Vl = (e, t, r) => t >= e.left && t <= e.right && r >= e.top && r <= e.bottom, rs = (e) => {
  const t = [];
  let r = is(e);
  for (; r; )
...
function Vs() {
  ve.push(import("./copilot-log-plugin-DZJhiSMo.js")), ve.push(import("./copilot-info-plugin-Do8zGsEn.js")), ve.push(import("./copilot-features-plugin-tc1ssT5Q.js")), ve.push(import("./copilot-feedback-plugin-BEKNiRJC.js")), ve.push(import("./copilot-shortcuts-plugin-CbDPhQ2e.js"));
}
function js() {
  {
...
const Ls = Wi(Or);
function Xi() {
  return import("./copilot-notification-BorVW3EP.js");
}
const Ms = (e) => {
